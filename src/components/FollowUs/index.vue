<template>
    <div class="guanzhu" id="follow-us" ref="follow">
      ...
      <ul>
<!--        &lt;!&ndash; <li class="sina"><a href="/" target="_blank"><span>新浪微博</span>蘑菇博客</a></li>         &ndash;&gt;{{contact.qqGroup}}-->
        <li class="qqGroup" v-if="contact.qqGroup"><a href="//shang.qq.com/wpa/qunwpa?idkey=88bc57d77601a3c5ae97fe6d9c0bfa25c2ae166d8f0b9f6da6f7294097be6d08" target="_blank"><span>QQ群</span></a></li>
        ...
        <li class="email" v-if="contact.email"><a :href="mailto" target="_blank"><span>邮箱帐号</span></a></li> <!--{{contact.email}}-->
